...
.curDiv h6{
 ...
 function sout(){
       ...
       window.location.href =n.substring(0, n.lastIndexOf('/')-4) ;
...
<div class="header">
  ...
  <div class="header-right"> 
    <a onclick="sout()"><i class="bi bi-file-earmark-text"></i>{{__('lang.main')}}
...
<h2>{{__('lang.assl')}}
  <button type="button" class="btn btn-sml butt" id="addUButton" onclick="addUF()">{{__('lang.assu')}}</button>
  <button type="button" class="btn btn-sml butt" id="addAssButton" onclick="addAssF()">{{__('lang.assa')}}</button>
    <button type="button"  class="btn butt" onclick="closeAddC()" style="display: none;" id="addClose">{{__('lang.close')}}</button></h2>
    ...
    <form method="POST" action="http://localhost/GC/public/store" >
    {{ csrf_field() }} <hr class="class4">
      <div id="addAss" > 
     <h3>{{__('lang.assm')}}<i class="bi bi-plus-circle-fill" style="margin-left: 10px;"></i></h3>
     
   <div class="curDiv" style="display: none;"><p>Course ID:</p><input type="Number" name="idcourse" value="<?php echo $nameC ?>"></div>
     <div class="curDiv"><p>{{__('lang.assn')}}</p><select  name="selecto" required>
              <option></option>
    ...
    <div class="curDiv"><p>{{__('lang.hm')}}</p> <input type="Number" name="weight"></div>
...
$sql = "SELECT * FROM assessments where courses_id = $nameC";
   ...
   <div style="width: 100%; background-color: lightgrey;"> 
    ...
    <form action="{{  route('upd')}}" method = "POST"> {{ csrf_field() }}
      <div class="curDiv" style="padding-top: 10px;"><h6>{{__('lang.assm')}}</h6><select  name="selectu" required>
    ...
    <div class="curDiv"><h6>{{__('lang.hm')}}</h6> <input type="Number" name="weightu" value="<?php echo $per ?>"required></div>
    <div class="curDiv"><h6>{{__('lang.cp')}}</h6> <input type="Number" name="cweightu" value="<?php echo $cper ?>"required></div>
    <input style="display: none;" type="Number" name="asidu" value="<?php echo $id; ?>" required>
       ...
       <input type="submit" value="{{__('lang.up')}}" style="margin-left: 53%; margin-top: -25px;">
  </form>
    ...
    <div class="curDiv" style="margin-left: 60%;margin-top: -30px;">
      ...
      <button  type="submit" class="btn" style="margin-left: 10px;"><i class="bi bi-trash"></i></button>
     ...
     <div class="class1"  style="padding: 10px;" id="<?php echo $id ?>">
            ...
            <div style="display: flex;flex-wrap: wrap;">
              <div style="width: 50%; margin-top: 50px;">
                ...
                <div class="w"><p>{{__('lang.nass')}}</p><h6 class="ch6"><?php echo $na ?></h6></div><hr class="hrc">
                <div class="w"><p>{{__('lang.cgoal')}}</p><h6 class="ch6"><?php echo $goal ?>%</h6></div><hr  class="hrc">
                <div class="w"><p>{{__('lang.cp')}}</p><h6 class="ch6"><?php echo $per ?>%</h6></div><hr  class="hrc">
              </div>
              <div>
